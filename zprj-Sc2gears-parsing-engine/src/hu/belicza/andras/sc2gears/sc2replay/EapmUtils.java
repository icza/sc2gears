...
public class EapmUtils {
	...
	public enum IneffectiveReason {
		...
		FAST_REPEAT_UNIT_ABILITY,
		FAST_REPEAT_BUILDING_ABILITY,
		FAST_REPEAT_OTHER_ABILITY,
		
		FAST_REPEAT_SAME_HOTKEY,
		FAST_SELECTION_CHANGE,
		
		REPEAT_HOTKEY_ASSIGN,
		
		REPEAT_UNIT_ABILITY,
		REPEAT_BUILDING_ABILITY,
		REPEAT_OTHER_ABILITY,
		REPEAT_RESEARCH,
		REPEAT_UPGRADE,
		REPEAT_BUILDING;
	}
