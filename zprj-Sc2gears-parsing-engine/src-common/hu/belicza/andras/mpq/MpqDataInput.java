...
public interface MpqDataInput extends Closeable {
	 ...
	 * 
	 * <p>Reading starts at the current position of this data provider,
	 * and the position is incremented by the number of read bytes.</p>
	 * 
	 * <p>The read bytes are put into the specified byte buffer, starting from its current position.
	 * This method attempts to read as many bytes as are available in the specified buffer.</p>
	 * 
